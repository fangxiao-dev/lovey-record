...
## 9. 当前 master 历史提炼的 10 个用户向版本（review draft）
...
- 重点：
  - 底部切换入口现在显示“聚焦模式”
  - 月历里的前后按钮样式更清晰，浏览时更容易看清方向
  - 到下次预测后会继续安静提示“暂无更后的月经记录”
...
- 覆盖：聚焦模式浏览、头部导航、月份显示
- 重点：
  - 聚焦模式现在可以按前一次和后一次经期连续浏览
  - 浏览到下次预测后，会直接提示“暂无更后的月经记录”
  - 月份标题和翻页按钮更清晰，跨年时更容易看懂
