...
5. Read [2026-03-28-frontend-integration-prep.md](D:/CodeSpace/hbuilder-projects/lovey-record-backend/backend/docs/2026-03-28-frontend-integration-prep.md) for mock-data scenarios, test priorities, and the placeholder for future real-DB preparation.
